...
angular
	...
	/**
	 * A data store that preserves the element/collection relationship. The term "store" will be used synonymously.
	 *
	 * ## Terminology
	 * An _element_ is a basic thing that can be contained in the store. A _collection_ consists
	 * of elements and can also be contained in the store. An _item_ is an element or a collection.
	 *
	 * ## Invariant
	 * For any element in the store, if the store contains a collection that the element belongs with, it will be 
	 * contained in the collection. For any collection contained in the store, its elements are also contained in the store.
	 * Note however that it is possible for elements to be contained in the store for which there is no collection in the
	 * store.
	 *
	...
	.factory('Store', function() {
		 ...
		 * @return The item contained in the store for that key, or `undefined` if no such item exists.
		 */
